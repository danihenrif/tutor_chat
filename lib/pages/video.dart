...
class Video extends StatelessWidget {
  ...
  const Video({super.key, required this.isSomeVideoSelected, required this.youtubeController});
  ...
  Widget build(BuildContext context) {
    return isSomeVideoSelected && youtubeController != null
        ? ClipRRect(
            ...
            child: SizedBox.expand(child: YoutubePlayer(controller: youtubeController!)),
          )
        : Column(
